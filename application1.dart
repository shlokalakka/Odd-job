...
class Cart_jobsApply extends StatefulWidget {
  @override
  _Cart_jobsApplyState createState() => _Cart_jobsApplyState();
}

class _Cart_jobsApplyState extends State<Cart_jobsApply> {
  var jobs_selected = [
    {
      "name": "Driver",
