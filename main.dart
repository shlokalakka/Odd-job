...
radius: 70.0,
child: Icon(
Icons.assessment,color:Colors.purpleAccent,size:120,
),
),
...
Text("P U R P L E",
style: TextStyle(color: Colors.purpleAccent,fontSize: 26.0,fontWeight: FontWeight.bold),
)
],
)
),
...
valueColor: new AlwaysStoppedAnimation(Colors.purpleAccent)),
),
