...
class ApplyJobDetails extends StatefulWidget {
  ...
  @override
  _ApplyJobDetailsState createState() => _ApplyJobDetailsState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: InkWell(
          onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> ApplyCart()));},
                ...
                child: MaterialButton(
                  onPressed: (){
                    ...
                    builder: (context){
                     return AlertDialog(
                       title: Text("Age"),
                       content: Text("Please abide by the eligibility age bracket"),
                       actions: <Widget>[
                ...
                child: MaterialButton(
                  onPressed: (){
                    ...
                    builder: (context){
                     return AlertDialog(
                       title: Text("Location"),
                       content: Text("Choose your Location"),
                       actions: <Widget>[
                         new MaterialButton(onPressed: (){
                           Navigator.of(context).pop(context);
                         },
                  ...
                  onPressed: (){
                    ...
                    builder: (context){
                     return AlertDialog(
                       ...
                       content: Text("Please apply according to the eligibility experience bracket"),
                       actions: <Widget>[
                         new MaterialButton(onPressed: (){
                           Navigator.of(context).pop(context);
                         },
...
//the second buttons
          ...
          {Navigator.push(context, MaterialPageRoute(builder: (context)=> ApplyCart()));};
                          },

                color: Colors.purple,
                textColor: Colors.white,
                elevation: 0.2,
                child: Text("Apply To Similar Domains"),
                ),
              ),
      ...
      child: Text("See what your relations are up to: "),
      ),
            ...
            child: InkWell(
              onTap: ()=> Navigator.of(context).push(
                new MaterialPageRoute(
                  ...
                  builder: (context) => new ApplyJobDetails(
